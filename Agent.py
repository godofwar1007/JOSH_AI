...
@tool
def search_wikipedia_with_images(query: str) -> str:
    """
...
def search_web_serper(query: str) -> str:
    ...
    api_key = "1d3d14200b773a7ed2b30283ccaedd3ea4b88ccf" # is deleted not for use , please place your own 
    if not api_key:
...
class OrchestratorAgent:
    ...
    async def initialize(self):
        ...
        self.tools = [search_wikipedia_with_images, search_web_serper]

     
        groq_api_key = "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" # its deleted go and generate yours 
    ...
    def _load_memory_node(self, state: AgentState) -> dict:
        system_prompt = """You are a highly capable AI assistant with access to web search and Wikipedia.
    ...
    def _tools_node(self, state: AgentState) -> dict:
        ...
        for tool_call in last_message.tool_calls:
            ...
            try:
                ...
                result = tool_func.invoke(tool_args) if tool_func else f"Tool '{tool_name}' not found"
